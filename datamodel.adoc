...
what details to be rendered in the UML diagram and document.
|===
...
|===
|Attribute    |Type                    |Mandatory? |Description
|skipSection  |Boolean                 |false      |Its value is to specify
whether the section about the model in the document should be rendered.
|===
