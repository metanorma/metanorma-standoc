      ...
      def self.included(base)
        base.class_eval do
          ...
          attribute :boilerplate,
                    Metanorma::Standoc::Document::Boilerplate
          attribute :metanorma_extension,
                    Metanorma::Standoc::Document::Metadata::MetanormaExtension
          attribute :annotation_container,
                    Metanorma::Standoc::Document::AnnotationContainer
          ...
          attribute :colophon,
                    Metanorma::Standoc::Document::Sections::Colophon
