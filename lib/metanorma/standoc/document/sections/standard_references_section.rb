...
module Metanorma
  module Standoc::Document
    module Sections
      ...
      # any prefatory text.
      class StandardReferencesSection < Metanorma::Standoc::Document::Sections::StandardSection
        attribute :normative, :boolean
        attribute :obligation, :string
        attribute :hidden, :boolean
        attribute :references, Metanorma::Document::Components::BibData::BibliographicItem,
                  collection: true
        attribute :passthrough, Metanorma::Standoc::Document::Blocks::Passthrough,
                  collection: true
        attribute :note,
