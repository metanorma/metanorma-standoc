...
module Metanorma
  module Standoc::Document
    module Sections
      ...
      class StandardHierarchicalSection < Metanorma::Standoc::Document::Sections::StandardSection
        attribute :subsections,
                  Metanorma::Standoc::Document::Sections::StandardSection, collection: true
