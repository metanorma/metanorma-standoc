...
module Metanorma
  module Standoc::Document
    module Blocks
      ...
      class Form < Metanorma::Standoc::Document::Blocks::StandardBlockNoNotes
        attribute :id, :string
        ...
        attribute :input, Metanorma::Standoc::Document::Elements::FormInput,
                  collection: true
        attribute :label, Metanorma::Standoc::Document::Elements::Label,
                  collection: true
