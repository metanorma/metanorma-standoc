    ...
    class Converter
      ...
      LOG_MESSAGES = {
        ...
        "STANDOC_2": { category: "Table", error: "Empty table",
                       severity: 0 },
        "STANDOC_3": { category: "Crossreferences", error: "invalid index \"%s\" cross-reference: wrong number of " \
            "attributes in `index:%s[%s]`",
                       severity: 0 },
        ...
        "STANDOC_22": { category: "Bibliography",
                        ...
                        severity: 1 },
        "STANDOC_23": { category: "Anchors", error: "%s",
                        severity: 0 },
        ...
        "STANDOC_25": { category: "Terms", severity: 0,
                        ...
                        ERROR
        "STANDOC_26": { category: "AsciiDoc Input", error: "Error: Symbol reference in `symbol[%s]` missing: \"%s\" is not defined in document",
                        severity: 1 },
        "STANDOC_27": { category: "AsciiDoc Input", error: "Error: Term reference to `%s` missing: \"%s\" is not defined in document%s",
                        severity: 1 },
        ...
        "STANDOC_45": { category: "Images",
                        ...
                        severity: 2 },
        "STANDOC_46": { category: "Images", error: "Image too large for Data URI encoding: disable Data URI encoding (`:data-uri-image: false`), or set `:data-uri-maxsize: 0`",
                        severity: 0 },
        "STANDOC_47": { category: "Crossreferences", error:  "mismatch of callouts (%s) and annotations (%s)",
                        severity: 0 },
        "STANDOC_48": { category: "Style", error: "%s",
                        severity: 2 },
        ...
        "STANDOC_51": { category: "Maths",
                        ...
                        severity: 1 },
        "STANDOC_52": { category: "Bibliography", error: "%s",
                        severity: 0 },
        "STANDOC_53": { category: "Bibliography", error: "%s",
                        severity: 1 },
        "STANDOC_54": { category: "Relaton", error: "%s",
                        severity: 0 },
        "STANDOC_55": { category: "Relaton", error: "%s",
                        severity: 1 },
        "STANDOC_56": { category: "Relaton", error: "%s",
                        severity: 2 },
        "STANDOC_57": { category: "Relaton", error: "%s",
                        severity: 3 },
        "STANDOC_58": { category: "Bibliography",
