...
By default, the https://github.com/metanorma/relaton[`relaton`] gem is used to look up the reference details for
...
`:language:` :: The language of the document. Defaults to `en`.
