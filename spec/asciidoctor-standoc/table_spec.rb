...
RSpec.describe Asciidoctor::Standoc do
  ...
  it "processes complex tables" do
    expect(strip_guid(Asciidoctor.convert(<<~"INPUT", backend: :standoc, header_footer: true))).to be_equivalent_to <<~"OUTPUT"
      #{ASCIIDOC_BLANK_HDR}
      [cols="<,^,^,^,^",options="header,footer",headerrows=2,alt="An extensive summary, and illustration, of tables",options="unnumbered"]
    ...
    INPUT
            #{BLANK_HDR}
       <sections>
         <table id="_" alt="An extensive summary, and illustration, of tables" unnumbered="true">
